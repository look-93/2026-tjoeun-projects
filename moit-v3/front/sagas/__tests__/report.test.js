...
describe('report saga', ()=> {
    ...
    it('createReport success', ()=> {
        ...
        const putStep =
            generator.next({ data: mockData }).value;


        // 3. 결과물확인
        expect(putStep).toEqual(
            put(createReportSuccess(mockData))
        );
    });
    ...
    it('updateReport success', ()=> {
        ...
        const generator = updateReport(
            updateReportRequest(payload)
        );
        ...
        // 3. 결과물확인
        expect(putStep).toEqual(
            put(updateReportSuccess(mockData))
        );
    });
    ...
    it('deleteReport success', ()=> {
        ...
        const generator = deleteReport(
            deleteReportRequest(payload)
        );
        ...
        // 2. 결과물받기
        // Controller가 삭제된 reportId를 반환
        const putStep =
            generator.next({ data: 10 }).value;


        // 3. 결과물확인
        expect(putStep).toEqual(
            put(deleteReportSuccess(10))
        );
    });
    ...
    it('checkDoubleReport success', ()=> {
        ...
        const generator = checkDoubleReport(
            checkDoubleReportRequest(payload)
        );
        ...
        // 3. 결과물확인
        expect(putStep).toEqual(
            put(checkDoubleReportSuccess(mockData))
        );
    });
    ...
    it('updateAdminReport success', ()=> {
        ...
        const generator = updateAdminReport(
            updateAdminReportRequest(payload)
        );
        ...
        // 3. 결과물확인
        expect(putStep).toEqual(
            put(updateAdminReportSuccess(mockData))
        );
    });
    ...
    it('deleteAdminReport success', ()=> {
        ...
        const payload = {
            reportId: 10,
            processReason: '관리자 삭제 처리'
        };

        const generator = deleteAdminReport(
            deleteAdminReportRequest(payload)
        );
        ...
        // 3. 결과물확인
        expect(putStep).toEqual(
            put(deleteAdminReportSuccess(10))
        );
    });
    ...
    it('fetchAdminReports success', ()=> {
        ...
        const generator = fetchAdminReports(
            fetchAdminReportsRequest(payload)
        );
        ...
        // 3. 결과물확인
        expect(putStep).toEqual(
            put(fetchAdminReportsSuccess(mockData))
        );
    });
    ...
    it('fetchAdminReportsDetail success', ()=> {
        ...
        const generator = fetchAdminReportsDetail(
            fetchAdminReportsDetailRequest(payload)
        );
        ...
        // 3. 결과물확인
        expect(putStep).toEqual(
            put(fetchAdminReportsDetailSuccess(mockData))
        );
    });
    ...
    it('fetchAdminReportAuditLogs success', ()=> {
        ...
        const generator = fetchAdminReportAuditLogs(
            fetchAdminReportAuditLogsRequest(payload)
        );
        ...
        // 3. 결과물확인
        expect(putStep).toEqual(
            put(fetchAdminReportAuditLogsSuccess(mockData))
        );
    });
    ...
    it('fetchMemberReportTrustInfo success', ()=> {
        ...
        const generator = fetchMemberReportTrustInfo(
            fetchMemberReportTrustInfoRequest(payload)
        );
        ...
        // 3. 결과물확인
        expect(putStep).toEqual(
            put(fetchMemberReportTrustInfoSuccess(mockData))
        );
    });
});
