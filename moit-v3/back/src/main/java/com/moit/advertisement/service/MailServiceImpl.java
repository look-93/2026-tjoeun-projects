...
public class MailServiceImpl implements MailService {
    ...
    public void sendAdvertisementReminderMail(AdvertisementDto ad, int remainDay) {
		 ...
		 * 
		 * helper.setFrom(mailSenderEmail); helper.setTo(ad.getEmail());
		 * helper.setSubject("[MOIT] 광고 종료 예정 안내");
		 * 
		 * String html = """ <html> <body
		 * style="font-family:Arial,sans-serif;background:#f5f5f5;padding:30px;">
		 * 
		 * <div style=" max-width:600px; margin:auto; background:white;
		 * border-radius:10px; padding:40px; border:1px solid #e5e5e5;">
		 * 
		 * <h2 style="color:#0d6efd;margin-top:0;"> 광고 종료 예정 안내 </h2>
		 * 
		 * <p> 안녕하세요. <b>%s</b>님. </p>
		 * 
		 ...
		 * 
		 * <a href="http://localhost:8080/user/advertisement/list" style="
		 ...
		 * </div>
		 * 
		 * </body> </html> """ .formatted( ad.getMemberName(), ad.getTitle(), remainDay
		 * );
		 * 
